...
final class FixtureController extends AbstractController
{
    ...
    public function index(FixtureRepository $fixtureRepository, #[MapQueryString] PaginationDTO $paginationDTO): Response
    {
        return $this->render('fixture/index.html.twig', [
            ...
            'pages' => ceil($fixtureRepository->countAll()/$paginationDTO->limit),
